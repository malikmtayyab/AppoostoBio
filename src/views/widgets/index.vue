  ...
  <Layout>
          ...
          <BCardBody>
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
              <div>
                ...
                <BLink href="" class="text-decoration-underline text-white-50"
            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <p class="mb-0 text-white-50">
                  <BBadge
                    variant="white"
                    class="bg-white bg-opacity-25 text-white mb-0"
                  >
        ...
        <BCard no-body class="bg-success card-height-100">
          <BCardBody>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
                <span
                  class="avatar-title bg-white bg-opacity-25 text-white rounded-2 fs-2"
                >
              ...
              <div class="flex-shrink-0 align-self-center">
                <BBadge
                  variant="white"
                  class="bg-white bg-opacity-25 text-white fs-12"
    ...
    <BRow>
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            <BDropdown
              variant="link"
              right
              toggle-class="text-decoration-none arrow-none p-0"
              class="float-end"
              no-caret
            >
            ...
            <p class="text-muted mb-0">
              <i class="ri-building-line align-bottom"></i> Themesbrand
              <span class="ms-2"
                ><i class="ri-map-pin-2-line align-bottom"></i> California</span
              >
            </p>
          </BCardBody>
        </BCard>
      ...
      <BCol xl="3" md="6">
        <BCard
          no-body
          class="card-height-100 bg-primary-subtle shadow-none bg-opacity-10"
        >
          <BCardBody>
            <BDropdown
              variant="link"
      ...
      <BCol xl="3" md="6">
        <BCard
          no-body
          class="card-height-100 bg-info-subtle shadow-none bg-opacity-10"
        >
          <BCardBody>
            <BDropdown
              variant="link"
            ...
            <div class="d-flex p-3">
              <div class="flex-shrink-0">
                <div class="avatar-md me-3">
                  <span
                    class="avatar-title bg-danger-subtle rounded-circle fs-1"
                  >
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="d-flex flex-wrap justify-content-evenly">
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-1-circle text-success fs-18 align-middle me-2"
                ></i
                >Completed
              </p>
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-3-circle text-info fs-18 align-middle me-2"
                ></i
                >In Progress
              </p>
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-2-circle text-primary fs-18 align-middle me-2"
                ></i
                >To Do
              </p>
            </div>
          ...
          <BProgress
            class="animated-progress rounded-bottom rounded-0"
            style="height: 6px"
          >
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="d-flex flex-wrap justify-content-evenly">
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-3-circle text-success fs-18 align-middle me-2"
                ></i
                >Completed
              </p>
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-0-circle text-info fs-18 align-middle me-2"
                ></i
                >In Progress
              </p>
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-8-circle text-primary fs-18 align-middle me-2"
                ></i
                >To Do
              </p>
            </div>
        ...
        <BCard no-body>
          <BCardBody>
            ...
            <div class="d-flex flex-wrap justify-content-evenly">
              <p class="text-muted mb-0">
                <i
                  class="mdi mdi-numeric-10-circle text-success fs-18 align-middle me-2"
                ></i
                >Completed
              </p>
              <p class="text-muted mb-0">
        ...
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            <BCardTitle class="mb-0 flex-grow-1"
              >Upcoming Activities</BCardTitle
            >
            <div class="flex-shrink-0">
              <BDropdown
                variant="link"
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol>
                    ...
                    <BLink href="#" class="text-reset fs-14 mb-0"
                      >Meeting for campaign with sales team</BLink
                    >
                  </BCol>
                  <BCol sm="auto">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol>
                    ...
                    <BLink href="#" class="text-reset fs-14 mb-0"
                      >Adding a new event with attachments</BLink
                    >
                  </BCol>
                  <BCol sm="auto">
                    <div class="avatar-group">
              ...
              <li class="list-group-item ps-0">
                <BRow class="align-items-center g-3">
                  ...
                  <BCol>
                    ...
                    <BLink href="#" class="text-reset fs-14 mb-0"
                      >Create new project Bundling Product</BLink
                    >
                  </BCol>
                  <BCol sm="auto">
                    <div class="avatar-group">
    ...
    <BRow>
      <BCol xxl="4" xl="6">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            <BCardTitle class="mb-0 flex-grow-1"
              >Live Users By Country</BCardTitle
            >
            <div class="flex-shrink-0">
              <BButton variant="soft-primary" size="sm">
                Export Report
        ...
        <BCard no-body class="card-height-100">
          <BCardHeader class="border-0 align-items-center d-flex">
            ...
            <div class="hstack gap-1 justify-content-end">
              <BButton variant="soft-secondary" size="sm"> ALL </BButton>
              <BButton variant="soft-secondary" size="sm"> 1M </BButton>
              <BButton variant="soft-secondary" size="sm"> 6M </BButton>
              <BButton variant="soft-primary" size="sm"> 1Y </BButton>
            </div>
          </BCardHeader>
          ...
          <BCardHeader class="p-0">
            <BAlert
              variant="warning"
              :model-value="true"
              class="alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center"
              show
            >
              <i class="ri-error-warning-line label-icon"></i>
              <div class="flex-grow-1 text-truncate">
    ...
    <BRow>
      ...
      <BCol xxl="4">
        <BCard no-body class="card-height-100">
          <BCardHeader class="align-items-center d-flex">
            <BCardTitle class="mb-0 flex-grow-1"
              >Top Referrals Pages</BCardTitle
            >
            <div class="flex-shrink-0">
              <BButton variant="soft-primary" size="sm">
                Export Report
        ...
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <p class="text-muted pb-1">
              ...
              you might be looking for the singlet T-shirt, which is also known
              as the half T-shirt.
            </p>
            ...
            <div class="d-flex mb-4 align-items-center">
              ...
              <div class="input-step flex-shrink-0">
                <button type="button" class="minus" @click="minusamount()">
                  –
                </button>
                <input
                  type="number"
                  ...
                  readonly
                />
                <button type="button" class="plus" @click="plusamount()">
                  +
                </button>
              </div>
            </div>

            <BLink href="#!" class="btn btn-soft-danger d-block"
              >Add to Cart</BLink
            >
          </BCardBody>
        </BCard>
          ...
          <BRow class="g-0">
            ...
            <BCol lg="6">
              <BCardBody class="text-center">
                ...
                <h5 id="candidate-name" class="mb-0">Ezio Grieco</h5>
        ...
        <BCard no-body class="card-height-100">
          ...
          <BCardBody>
            ...
            <form id="custom-card-form" autocomplete="off">
              <div class="mb-3">
                <label for="card-num-input" class="form-label"
                  >Card Number</label
                >
                <input
                  id="card-num-input"
              ...
              <div class="mb-3">
                <label for="card-holder-input" class="form-label"
                  >Card Holder</label
                >
                <input
                  type="text"
              ...
              <BRow>
                <BCol lg="4">
                  <div>
                    <label for="expiry-month-input" class="form-label"
                      >Expiry Month</label
                    >
                    <select
                      class="form-select"
                ...
                <BCol lg="4">
                  <div>
                    <label for="expiry-year-input" class="form-label"
                      >Expiry Year</label
                    >
                    <select
                      class="form-select"
              ...
              <BButton variant="danger" class="w-100 mt-3" type="submit"
                >Pay Now</BButton
              >
            </form>
          </BCardBody>
        ...
        <BCard no-body>
          ...
          <BCardBody>
            <div class="card-wrapper mb-3">
              <div class="mx-auto" style="max-width: 350px">
                <div
                  class="text-bg-success bg-gradient p-4 rounded-3 mb-3 credit-card"
                >
                  <div class="d-flex">
                    <div class="flex-grow-1">
            ...
            <div class="form-container active">
              <form action="" id="card-form-elem" autocomplete="off">
                <div class="mb-3">
                  <label for="card-number-input" class="form-label"
                    >Card Number</label
                  >
                  <input
                    class="form-control"
                ...
                <div class="mb-3">
                  <label for="card-name-input" class="form-label"
                    >Card Holder</label
                  >
                  <input
                    class="form-control"
                ...
                <BRow>
                  <BCol sm="6">
                    <div class="mb-3">
                      <label for="card-expiry-input" class="form-label"
                        >Expiry</label
                      >
                      <input
                        class="form-control"
                ...
                <BButton variant="danger" class="w-100" type="submit"
                  >Pay Now</BButton
                >
              </form>
            </div>
