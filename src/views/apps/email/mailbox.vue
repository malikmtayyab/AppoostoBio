                        ...
                        <BRow>
                            ...
                            <div class="col-auto">
                                <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 remove-mail" @click="removeModal = !removeModal">
                                        <i class="ri-delete-bin-5-fill align-bottom"></i>
                                    </BButton>
                                    <div class="dropdown">
                                        <BButton variant="ghost-secondary" size="sm" class="btn-icon fs-16" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
