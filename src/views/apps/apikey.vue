      ...
      <BCol lg="4">
        <BCard no-body class="card-height-100">
          <BCardBody>
            ...
            <div class="text-end">
              <BLink
                class="btn btn-success button create-btn btn-sm"
                type="button"
                id="createApi-btn"
                @click="(e) => handleApikeydetails(e)"
                >Create API Key</BLink
              >
            </div>
          </BCardBody>
        </BCard>
              ...
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-light text-success mb-0"
                    ><i class="ri-arrow-up-line align-middle"></i> 8.24 %
                  </BBadge>
                  7 last week
                </p>
              </div>
              ...
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-light text-danger mb-0"
                    ><i class="ri-arrow-down-line align-middle"></i> 25.87 %
                  </BBadge>
                  7 last week
                </p>
              </div>
                    ...
                    <tr v-for="(data, index) of resultQuery" :key="index">
                      ...
                      <td>
                        ...
                        >
                          ...
                          <BDropdownItem
                            linkClass="regenerate-api-btn"
                            id="regenerate-api-btn"
                            @click="(e) => handleApikeydetails(e, data)"
                          >
                            Regenerate Key
                          </BDropdownItem>
                          <BDropdownItem
                            linkClass="disable-btn"
                            id="disable-btn"
                            href="javascript:void(0);"
                            @click="(e) => changestatus(data)"
                            >{{
                              data.status == "Active" ? "Disable" : "Active"
                            }}
                          </BDropdownItem>
                          <BDropdownItem
                            linkClass="remove-item-btn"
                ...
                <div class="noresult" v-if="resultQuery.length < 1">
                  <div class="text-center">
                    ...
                    <p class="text-muted mb-0">
                      We've searched more than 150+ API Keys We did not find any
                      API for you search.
                    </p>
                  </div>
                </div>
    ...
    >
      <BForm autocomplete="off" id="addform">
        ...
        <div class="mb-3">
          <label for="api-key-name" class="form-label"
            >API Key Name <span class="text-danger">*</span></label
          >
          <input
            type="text"
            class="form-control"
      ...
      <div class="hstack gap-2 justify-content-end mt-3">
        <BButton
          type="button"
          variant="secondary"
          @click="createApiModal = false"
          id="close-modal"
          >Close</BButton
        >
        <BButton
          variant="primary"
          id="createApimodal-btn"
          @click="(e) => handleApikeydetails(e)"
          >Create API</BButton
        >
        <BButton
