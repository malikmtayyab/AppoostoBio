...
<template>
  <Layout>
        ...
        <BRow class="g-2">
          <BCol lg="auto">
            <div class="hstack gap-2">
              <BButton variant="primary" @click="modalShow1 = !modalShow1"
        ...
        <div class="d-flex mb-3">
          <div class="flex-grow-1">
            <h6 class="fs-14 text-uppercase fw-semibold mb-0">
              Unassigned
              <BBadge tag="small" variant="success" class="align-bottom ms-1"
                >2</BBadge
              >
            </h6>
          </div>
          <div class="flex-shrink-0">
            <BDropdown
              ...
              toggle-class="p-0 arrow-none"
              menu-class="dropdown-menu-end"
              :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }"
            >
              <template #button-content
                ><span class="fw-medium text-muted fs-12"
                  >Priority<i class="mdi mdi-chevron-down ms-1"></i></span
              ></template>
              ...
              >
                <BCardBody>
                  <div class="d-flex mb-2">
                    ...
                    <BDropdown
                      variant="link"
                      toggle-class="text-muted p-0 arrow-none"
                      :offset="{
                        alignmentAxis: -130,
                        crossAxis: 0,
                        mainAxis: 10,
                    ...
                    >
                      ...
                      ></template>
                      <BDropdownItem to="/apps/tasks-details"
                        ><i
                      ...
                      <BDropdownItem @click="deleteTask">
                        <i
                  ...
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                      <BBadge
                        ...
                        class="bg-primary-subtle text-primary me-1"
                      ...
                      <ul class="link-inline mb-0">
                        <li class="list-inline-item">
                          <BLink href="javascript:void(0)" class="text-muted"
                            ><i class="ri-eye-line align-bottom"></i> 04</BLink
                          >
                        </li>
                        <li class="list-inline-item">
                          <BLink href="javascript:void(0)" class="text-muted"
      ...
      <div class="tasks-list">
        <div class="d-flex mb-3">
          <div class="flex-grow-1">
            <h6 class="fs-14 text-uppercase fw-semibold mb-0">
              To Do
              <BBadge tag="small" variant="secondary" class="align-bottom ms-1"
                >2</BBadge
              >
            </h6>
          </div>
      ...
      <div class="tasks-list">
        <div class="d-flex mb-3">
          <div class="flex-grow-1">
            <h6 class="fs-14 text-uppercase fw-semibold mb-0">
              Inprogress
              <BBadge tag="small" class="bg-warning align-bottom ms-1"
                >2</BBadge
              >
            </h6>
          </div>
    ...
    <BModal
      v-model="modalShow"
      header-class="p-3 bg-warning-subtle"
    ...
    >
      ...
      <div class="modal-footer v-modal-footer">
        <BButton type="button" variant="light" @click="modalShow = false"
          ><i class="ri-close-line align-bottom me-1"></i> Close</BButton
        >
        <BButton type="button" variant="success" id="addMember"
          >Add Member</BButton
        >
      </div>
    </BModal>
          ...
          <div class="mt-4">
            <div class="hstack gap-2 justify-content-end">
              <BButton type="button" variant="light" @click="modalShow1 = false"
                >Close</BButton
              >
              <BButton type="button" variant="success" id="addNewBoard"
                >Add Board</BButton
              >
            </div>
          </div>
                ...
                <li>
                  <div class="form-check d-flex align-items-center">
                    ...
                    >
                      ...
                      <span class="flex-grow-1 ms-2"> Ezio Grieco </span>
                    </label>
                  </div>
                </li>
                <li>
          ...
          <div class="mt-4">
            <div class="hstack gap-2 justify-content-end">
              <BButton type="button" variant="light" @click="modalShow2 = false"
                >Close</BButton
              >
              <BButton type="button" variant="success" @click="addNewTask"
                >Add Task</BButton
              >
            </div>
          </div>
