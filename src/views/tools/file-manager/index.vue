...
export default {
  ...
  methods: {
    ...
    updatefile() {
      let result = this.filelist.findIndex(
        (o) => o.id == document.getElementById("fileId").value
      );
    ...
    editfolder(folder) {
      this.folderModal = true;
      document.getElementById("modal-id").style.display = "block";
      document.querySelector(".exampleModalLabelFolder").innerHTML =
        "Update Folder";
    ...
    updateFolder() {
      let result = this.folders.findIndex(
        (o) => o.id == document.getElementById("folderId").value
      );
      this.folders[result].name =
...
<template>
  <Layout>
    <PageHeader title="File Manager" pageTitle="Tools" />
                ...
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0 me-2 d-block d-lg-none">
                    <BButton
                      ...
                      size="sm"
                      type="button"
                      class="btn-icon fs-16 file-menu-btn"
                    >
                  ...
                  <BCardBody>
                    <div class="d-flex mb-1">
                      ...
                      >
                        ...
                        <BDropdownItem @click="editfolder(folder)">
                          Rename
                        </BDropdownItem>
                        <BDropdownItem @click="deletefolder(folder)">
                          Delete
                        </BDropdownItem>
                      </BDropdown>
                    </div>
                    ...
                    <td>
                      ...
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 fs-17 me-2 filelist-icon">
                          <i
                            class="ri-gallery-fill align-bottom text-success"
                            v-if="
                          ...
                          ></i>
                          <i
                            class="ri-file-pdf-fill align-bottom text-danger"
                            v-if="
                              fileData.fileName.includes('.') &&
                          ...
                          ></i>
                          <i
                            class="ri-file-text-fill align-bottom text-secondary"
                            v-if="
                              fileData.fileName.includes('.') &&
                    ...
                    <td>
                      <div class="d-flex gap-3 justify-content-center">
                        <BButton
                          variant="ghost-primary"
                          size="sm"
                          class="btn-icon favourite-btn active"
                        ...
                        >
                          ...
                          <BDropdownItem class="viewfile-list">
                            View
                          </BDropdownItem>
                          <BDropdownItem
                            class="edit-list"
                            @click="fileDataEdit(fileData)"
                          >
                            Rename
                          </BDropdownItem>
                          <BDropdownItem
            ...
            >
              ...
              <div>
                <BButton
                  ...
                  variant="soft-danger"
                  size="sm"
                  class="btn-icon fs-16 close-btn-overview"
            ...
            <div class="d-flex h-100 flex-column">
              ...
              >
                ...
                <div>
                  <BButton
                    ...
                    variant="ghost-primary"
                    size="sm"
                    class="btn-icon fs-16 favourite-btn"
                  >
              ...
              <div class="pb-3 border-bottom border-bottom-dashed mb-3">
                ...
                <BButton
                  ...
                  size="sm"
                  class="btn-icon float-end fs-16"
                >
              ...
              <div class="mt-auto border-top border-top-dashed py-3">
                <div class="hstack gap-2">
                  ...
                  <BButton
                    variant="soft-danger"
                    type="button"
                    class="w-100 remove-file-overview"
                  >
