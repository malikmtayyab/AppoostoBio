...
export default {
  ...
  methods: {
    ...
    editSubmit(e) {
      ...
      const date = this.editevent.editcalendardates
        .split(" ")
        .filter((item) => item !== "to");
      const startDate = date[0];
      const endDate = date[1];
    ...
    editEvent(info) {
      ...
      this.editevent.editcalendardates =
...
<template>
  <Layout>
    <PageHeader title="Calendar" pageTitle="Tools" />
            ...
            <BCard no-body class="card-h-100">
              <BCardBody>
                ...
                <div id="external-events">
                  ...
                  >
                    <i class="mdi mdi-checkbox-blank-circle me-2"></i>Create New
                    theme
                  </div>
                </div>
              </BCardBody>
                  ...
                  <BCardBody>
                    <div class="d-flex mb-3">
                      <div class="flex-grow-1">
                        <i
                          :class="`mdi mdi-checkbox-blank-circle me-2 ${event.classNames}`"
                        ></i
                        ><span class="fw-medium">{{
                          this.dateStamp(event.start, event.end)
                        }}</span>
                      </div>
                      <div class="flex-shrink-0">
                        <BBadge
                          ...
                          >{{ this.timeStamp(event.start, event.end) }}</BBadge
                        >
                      </div>
                    </div>
        ...
        <div class="row event-form">
            ...
            <div class="mb-3">
              ...
              <div>
                <input
                  ...
                  :class="{
                    'is-invalid': submitted && v$.event.location.$error,
                  }"
                />
                <div
                  v-if="submitted && v$.event.location.$error"
                  class="invalid-feedback"
                >
          ...
          <div class="col-12">
            <div class="mb-3">
              ...
              ></textarea>
              <div
                v-if="submitted && v$.event.descri.$error"
                class="invalid-feedback"
              >
    ...
    >
      <div class="text-end">
        <a
          ...
          data-id="edit-event"
          role="button"
          @click="(this.eventEditModal = true), (this.eventModal = false)"
          >Edit</a
        >
      </div>
        ...
        <div class="row event-form">
          ...
          <div class="col-12">
            <div class="mb-3">
              ...
              <input
                id="name"
                v-model="this.editevent.editTitle"
                type="text"
                class="form-control"
                placeholder="Insert Event name"
              />
          ...
          <div class="col-12">
            <div class="mb-3">
              ...
              <div class="input-group">
                <flat-pickr
                  placeholder="Select date"
                  v-model="editevent.editcalendardates"
                  :config="timeConfig"
                  class="form-control flatpickr-input"
                  id="caledate"
                ></flat-pickr>
