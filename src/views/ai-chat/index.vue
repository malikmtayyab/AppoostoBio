      ...
      <div class="offcanvas-body profile-offcanvas p-0">
        ...
        <div class="p-3 text-center">
          ...
          <div class="d-flex gap-2 justify-content-center">
            <BButton variant="light" class="avatar-xs p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Message">
              <span class="avatar-title rounded bg-light text-body">
                <i class="ri-question-answer-line"></i>
              </span>
            </BButton>

            <BButton variant="light" class="avatar-xs p-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Favourite">
              <span class="avatar-title rounded bg-light text-body">
            ...
            <div class="dropdown">
              <BButton variant="light" class="avatar-xs p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0 ms-2">
                  <div class="d-flex gap-1">
                    <BButton variant="white" class="btn-icon text-muted btn-sm fs-18"><i class="ri-download-2-line"></i></BButton>
                    <div class="dropdown">
                      <BButton variant="white" class="btn-icon text-muted btn-sm fs-18 dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="ri-more-fill"></i>
                      </BButton>
