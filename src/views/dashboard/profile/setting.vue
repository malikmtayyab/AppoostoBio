        ...
        <BCard no-body class="mt-n5">
          <BCardBody class="p-4">
            <div class="text-center">
              ...
              <h5 class="fs-16 mb-1">Ezio Grieco</h5>
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <div class="flex-shrink-0">
                <BLink
                  href="javascript:void(0);"
                  class="badge bg-light text-primary fs-12"
                  ><i class="ri-add-fill align-bottom me-1"></i> Add</BLink
                >
              </div>
            </div>
                    ...
                    <BCol lg="12">
                      <div class="mb-3 pb-2">
                        ...
                        <textarea
                          ...
                          rows="3"
                        >
Hi I'm Ezio Grieco,It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family.</textarea
                        >
                      </div>
                    </BCol>
                    <BCol lg="12">
